                        ...
                        <>
                            <form onSubmit={handlePasswordSubmit} method="post">
                                ...
                                <div>
                                    <button
                                    type="submit"
                                    className={`inline-flex w-full items-center justify-center rounded-md ${buttonDisabled?'bg-yellow-300':'bg-yellow-500'} px-3.5 py-2.5 font-semibold leading-7 text-white ${buttonDisabled?'':'hover:bg-yellow/80'}`}
                                    >
